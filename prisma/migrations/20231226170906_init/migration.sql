...
INSERT INTO "new_contracts" ("bidding_type_id", "billingDay", "created_at", "fixture", "id", "number", "supplier_id", "updated_at") SELECT "bidding_type_id", "billingDay", "created_at", "fixture", "id", "number", "supplier_id", "updated_at" FROM "contracts";
